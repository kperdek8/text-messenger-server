...
#
#     PHX_SERVER=true bin/text_messenger_server start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :text_messenger_server, TextMessengerServerWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  #
  #     config :text_messenger_server, TextMessengerServer.Mailer,
