...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/text_messenger_server ./
...
CMD ["sh", "-c", "bin/text_messenger_server eval \"TextMessengerServer.Release.migrate()\" && bin/text_messenger_server start"]